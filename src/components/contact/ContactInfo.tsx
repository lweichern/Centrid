    ...
    <div>
        ...
        <RevealOnScroll delay={0.05}>
          <div className="bg-gray-50 rounded-2xl p-6">
            ...
            <a
              ...
              className="text-lg font-serif text-navy hover:text-primary transition-colors"
            >
              {CONTACT.phone}
            </a>
          </div>
        ...
        <RevealOnScroll delay={0.1}>
          <div className="bg-gray-50 rounded-2xl p-6">
            ...
            <a
              ...
              className="text-lg font-serif text-navy hover:text-primary transition-colors break-all"
            >
              {CONTACT.email}
            </a>
          </div>
      ...
      <RevealOnScroll delay={0.25}>
        <div className="mt-12 text-center">
          <p className="text-xs uppercase tracking-wider text-navy/40 mb-4">Follow Us</p>
          <div className="flex items-center justify-center gap-4">
            <a
              href={CONTACT.facebook}
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center text-navy/40 hover:bg-primary hover:text-white transition-all duration-300"
              aria-label="Facebook"
            >
